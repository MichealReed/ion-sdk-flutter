      ...
      case 'peer-join':
        {
          ...
          this.emit('peer-join', null, [rid, uid, info]);
          break;
        }
      case 'peer-leave':
        {
          ...
          this.emit('peer-leave', null, [rid, uid]);
          break;
        }
      case 'stream-add':
        {
          ...
          this.emit('stream-add', null, [rid, mid, info, tracks]);
          break;
        }
      case 'stream-remove':
        {
          ...
          this.emit('stream-remove', null, [rid, mid]);
          this._removePC(mid);
          break;
        }
      case 'broadcast':
        {
          ...
          this.emit('broadcast', null, [rid, uid, info]);
          break;
        }
    }
  }
